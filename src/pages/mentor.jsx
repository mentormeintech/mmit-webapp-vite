  ...
  return (
    <>
      {loading ? <Spinner loading={loading} /> : <div className="flex">
        ...
        <section className="w-full mt-36 py-8 px-5 mb-6">
          <div className="w-[600px] mb-6">
            ...
            <div className="w-fit">
              <div className="flex items-center">
                <div className="text-[24px] text-[#3A3A3A] font-[600] mr-3">Rating Unavailable</div>
                {/* <div className="flex items-center">
                  {
                    arr?.map((x, index) => {
...
{/* 
          ...
          <div className="flex border w-fit p-2 gap-6 bg-[#F3F3F3]">
          ...
          <div className="flex gap-12 mt-5">
            <div>
              <h1 className="text-[36px] font-[600] mb-2">Community Statistics</h1>
