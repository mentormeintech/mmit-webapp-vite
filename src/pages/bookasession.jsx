		...
		<>
			{loading ? (
				...
				<div className="justify-center overflow-hidden m-auto w-[100%]">
					...
					<div className="ml-[10px] sm:ml-[100px]  mb-[5px] font-medium text-[20px] sm:text-[30px]">
						Get connected to the best mentors
					</div>
					<div className="ml-[10px] sm:ml-[100px]  sm:w-[50%] mb-[30px] text-[#434343] font-[500] text-[13px] sm:text-[17px]">
						Book and meet over 1k mentors for 1:1 mentors in our
						global Communtiy
					</div>
