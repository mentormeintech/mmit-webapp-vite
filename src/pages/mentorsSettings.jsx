        ...
        >
          <section className="w-9/12 mt-36 py-8 px-5">
            ...
            <ul className="flex items-center mb-12 w-10/12 justify-between">
              ...
              <li
                className={`relative cursor-pointer group ${
                  mentorship.personalInfo ? "text-[#0F88D9]" : ""
                }`}
              ...
              >
                <div
                  className={`group-hover:w-full transition-all delay-500 ease-in h-[2px] bg-[#0F88D9] absolute left-0 -bottom-[3px] ${
                    mentorship.personalInfo ? "w-full" : "w-0"
                  }`}
                ></div>{" "}
                Personal Info
              </li>
              ...
              <li
                className={`relative cursor-pointer group ${
                  mentorship.login ? "text-[#0F88D9]" : ""
                }`}
                onClick={displayLogin}
              >
                <div
                  className={`group-hover:w-full transition-all delay-500 ease-in h-[2px] bg-[#0F88D9] absolute left-0 -bottom-[3px] ${
                    mentorship.login ? "w-full" : "w-0"
                  }`}
                ></div>
                Login and security
              </li>
              ...
              <li
                className={`relative cursor-pointer group ${
                  mentorship.notification ? "text-[#0F88D9]" : ""
                }`}
                onClick={displayNotification}
              >
                <div
                  className={`group-hover:w-full transition-all delay-500 ease-in h-[2px] bg-[#0F88D9] absolute left-0 -bottom-[3px] ${
                    mentorship.notification ? "w-full" : "w-0"
                  }`}
                ></div>
