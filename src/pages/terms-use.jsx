        ...
        <div className="mt-[4rem]">
          ...
          <>
            ...
            {termsData.intellectualarray?.map((intellectual, index) => (
              <PolicyText key={index}>{intellectual}</PolicyText>
            ))}
            <PolicyHeadTitle className="mt-[2.6rem]">
          ...
          {/* Step 4 */}
          <>
            <PolicyHeadTitle>{termsData.indentification}</PolicyHeadTitle>
            <PolicyText>{termsData.indentificationtext}</PolicyText>
            <PolicyHeadTitle>{termsData.modification}</PolicyHeadTitle>
            {termsData.modificationarray?.map((modification, index) => (
              <PolicyText key={index}>{modification}</PolicyText>
            ))}
            <PolicyHeadTitle>{termsData.thirdparty}</PolicyHeadTitle>
          ...
          <>
            ...
            <PolicyHeadTitle>{termsData.severability}</PolicyHeadTitle>
            ...
            <PolicyText className="mt-[3rem]">{termsData.using}</PolicyText>
          </>
        </div>
      </div>
      <Footer />
