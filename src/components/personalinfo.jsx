  ...
  return (
    <form className="w-full lg:w-9/12">
      ...
      <div className="mb-8">
        ...
        <textarea
          id="about"
          className="bg-transparent outline-none h-40 lg:h-56 bg-[#FDF8F8] resize-none w-full py-2 px-4 text-sm lg:text-base border border-black border-[.5px]"
          name="about_me"
          onChange={handleChange}
      ...
      {/* Save Button */}
      <button className="bg-[#FE9B7E] rounded-md w-full lg:w-96 h-11 text-white text-sm lg:text-base hover:bg-[#FF8A6A] transition-colors duration-300" onClick={submitForm}>
        Save
      </button>
    </form>
  )
